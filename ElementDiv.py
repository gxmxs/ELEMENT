...
class Discord(object):
   ...
   ███████╗███████╗███████╗██║ ╚═╝ ██║███████╗██║ ╚████║   ██║   
   ╚══════╝╚══════╝╚══════╝╚═╝     ╚═╝╚══════╝╚═╝  ╚═══╝   ╚═╝   
                   criado por | gxmxs#0001 
                   https://github.com/gxmxs                   
{Fore.RESET}"""
        )

        print(f"""{Fore.BLUE}   [-] {Fore.GREEN}Adicione o seu token na lista antes de iniciar.
            {Fore.RESET}""")

        self.invite = input(f"  {Fore.BLUE} [?] {Fore.GREEN}Convite do Servidor:{Fore.RESET} ")
